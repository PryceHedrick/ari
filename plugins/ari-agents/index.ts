 ...
 * and a context plane — MISSION or BUILD:
 *
 ...
 *
 *   BUILD plane  (engineering only — NO business context, NO SOUL files):
 *     RUNE  🔧  claude-sonnet-4-6  Engineering Builder
 *
 * Note: "BUILD plane" = engineering context isolation. Separate from the openai-codex model.
...
const plugin = {
  ...
  name: "ARI Agents",
  description:
    "ARI named agent coordinator — MISSION plane (ARI/NOVA/CHASE/PULSE/DEX) + BUILD plane (RUNE, engineering-only context)",
